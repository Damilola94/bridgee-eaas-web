    ...
    <section className="w-full relative bg-[#FAE9FC] overflow-">
      <div className="w-full relative header-content overflow-visible">
        <div className="w-full mx-auto text-center pt-14 flex flex-col items-center justify-center">
          ...
          <h1 className="text-bold ff-bold text-4xl sm:text-5xl md:text-7xl mb-4 md:leading-tight">
          ...
          <h4 className="text-lg leading-relaxed mb-10 max-w-4xl">
            What sets Bridge apart is our strong partnership with Wema Bank, one
            of Nigeria&apos;s leading financial institutions. This collaboration
            empowers Bridge with the financial expertise, security
            infrastructure, and resources necessary to deliver a reliable and
            trustworthy service to our users.
          </h4>
        </div>
      </div>
    </section>
